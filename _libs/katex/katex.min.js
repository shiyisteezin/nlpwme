    ...
    var Gn = {
      ...
      Un = function () {
        ...
        return t.feed = function (e) {
          ...
          return this.macros.has(e) || Nn.hasOwnProperty(e) || ae.math.hasOwnProperty(e) || ae.text.hasOwnProperty(e) || Gn.hasOwnProperty(e)
      ...
      jn = function () {
        ...
        return t.expect = function (e, t) {
          ...
          _n.hasOwnProperty(t[0]) && !ae[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = _n[t[0]] + t.substr(1));
          var i, o = In.exec(t);
